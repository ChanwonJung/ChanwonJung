<div align= "center">
    ...
    <div style="font-weight: 700; font-size: 15px; text-align: left; color: #c9d1d9;"> I'm interested in SLAM and Navigation using ROS2.</li></li>Recently, I have become more interested in object recognition (YOLO) and data segmentation using Computer vision.</li></li>I plan to study more about camera calibration soon. </div> 
    </div>
    <div style="text-align: left;">
